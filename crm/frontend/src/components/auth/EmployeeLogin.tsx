// components/auth/EmployeeLogin.tsx
import React, { useState } from 'react';
import { Link, useNavigate } from 'react-router-dom';
import { ArrowLeft, Eye, EyeOff, Briefcase, Lock, Mail, Shield, AlertCircle } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="text-center">
                    <Link
                        to="/"
                        className="inline-flex items-center text-green-600 hover:text-green-800 mb-6 transition-colors group"
                    >
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-gray-600">Sign in to your Casa Community employee account</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center space-x-2 bg-white rounded-full px-4 py-2 shadow-sm border border-gray-100 mb-6">
                        ...
                        <span className="text-sm text-gray-700 font-medium">Secure Staff Login</span>
                    </div>
                </div>
                    ...
                    <div className="space-y-4">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-white text-gray-500">New Casa Community employee?</span>
                            </div>
                        </div>
                        ...
                        <div className="text-center">
                            <p className="text-sm text-gray-500">
                                ...
                                <Link to="/client/signin" className="text-blue-600 hover:text-blue-800 font-medium">
                                    Use Client Portal
                                </Link>
                            </p>
                        </div>
