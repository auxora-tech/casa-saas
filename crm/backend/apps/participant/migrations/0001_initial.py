    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('MALE', 'Male'), ('FEMALE', 'Female'), ('OTHER', 'Other / Non-binary'), ('PREFER_NOT_TO_SAY', 'Prefer not to say')], verbose_name='Gender')),
                ...
                ('guardian_name', models.CharField(default='John Doe', max_length=30, verbose_name='Guardian Name')),
                ('guardian_address', models.TextField(default='Australia', max_length=100, verbose_name='Guardian Address')),
                ('guardian_contact', phonenumber_field.modelfields.PhoneNumberField(default='458493', max_length=128, region=None, verbose_name='Guardian Contact')),
